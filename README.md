...
- 📩 [**DataGyver Newsletter**](https://pim.ms/t8Oupvs) → Monthly Python/SQL tips for data analysts.
...
- 📖 Author of [**"Business Intelligence with Python"**](https://pim.ms/fXwQaXx)
- 👨‍🏫 Creator of the **[Streamlit Unleashed](https://pim.ms/FVxfRFG)** & **[Portfolio](https://pim.ms/DN3A820)** courses
- 💼 Creator of the [**DataGyver Newsletter**](https://pim.ms/x89Vem4)
- 🔧 Tech mentor & data productivity trainer
- ✍️ Writer on [**Medium**](https://pim.ms/MEDIUM)
- 🐻 Creator of [**baribal**](https://github.com/gpenessot/baribal) — R-inspired data wrangling helpers
- 🎯 Coach via [**1:1 Sessions on Cal.com**](https://pim.ms/mbxaNsn)
...
- 🏆 **Craft a job-winning portfolio** that showcases your real-world data skills.
- 🚀 **Build powerful data apps & dashboards** with Streamlit, Plotly, and Python.
- 📈 **Become a productive Data Analyst** with modern Python & SQL (pandas, polars, DuckDB).
- 🛠️ **Automate your workflows** and build APIs (FastAPI, GitHub Actions).
- 🧪 **Train data teams** on Git, clean code & code review best practices.
...
### 🛠️ Developer Tools
- GitHub Portfolio Analyzer (AI-powered, core of my new course)
